[![Build Status](https://dev.azure.com/adhip12/testCode1/_apis/build/status/adhipgupta.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/adhip12/testCode1/_build/latest?definitionId=1&branchName=master)
